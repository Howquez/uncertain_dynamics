...
function calculate() {
    yourContribution = parseInt(document.getElementById("yourContribution").value) || 0;
    othersContributions = parseInt(document.getElementById("othersContributions").value) || 0;
    ...
    document.getElementById("calculator_button").innerHTML = "Erneut berechnen";
}
